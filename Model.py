...
class Model: 
	...
	def setupRNN(self):
		...
		# bidirectional RNN
		# BxTxF -> BxTx2H
		((fw, bw), _) = tf.nn.bidirectional_dynamic_rnn(cell_fw=rnn, cell_bw=rnn, inputs=rnnIn3d, dtype=rnnIn3d.dtype)
	...
	def save(self):
		"save model to file"
		self.snapID += 1
		self.saver.save(self.sess, 'model', global_step=self.snapID)
